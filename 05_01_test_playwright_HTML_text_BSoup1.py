...
with sync_playwright() as p:
    ...
    # Try selecting the main content tag
    main_selector = "main, article, .content, .document"  # common doc containers
    main_text = page.inner_text(main_selector)
...
headings = [h.text for h in soup.select("h1, h2, h3")]
print(headings)